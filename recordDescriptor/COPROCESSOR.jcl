...
//STEPLIB  DD DSN=IGY.V6R3M0.SIGYCOMP,DISP=SHR   <-- Your COBOL compiler library
//         DD DSN=DSN1210.SDSNEXIT,DISP=SHR      <-- Your Db2 Exit Library
//         DD DSN=DSN1210.SDSNLOAD,DISP=SHR      <-- Your Db2 Load library
...
//         DD DSN=DSN1210.SDSNLOAD,DISP=SHR      <-- Db2 runtime support libraries
...
//SYSUT1   DD SPACE=(CYL,(1,1)),UNIT=SYSDA
//SYSIN    DD *
 INCLUDE SYSLIB(DSNELI)                          <-- Includes Db2 TSO connection modules.
 ENTRY DB2MRGBT
/*
